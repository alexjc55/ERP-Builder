...
('fields.formatInheritHint', '{"ru":"Если значение этого поля копируется автоматизацией из другого места, укажите источник — цвета (условное форматирование поля или цвета статусов) будут применяться к значению автоматически. Нет совпадения — без форматирования.","en":"If this field''s value is copied by an automation from elsewhere, pick the source — its colors (the field''s conditional formatting or status colors) will follow the value automatically. No match — no formatting.","he":"אם ערך השדה מועתק על ידי אוטומציה ממקום אחר, בחרו מקור — הצבעים (עיצוב מותנה של השדה או צבעי הסטטוסים) יוחלו על הערך אוטומטית. אין התאמה — ללא עיצוב."}'),
('fields.formatInheritAdd', '{"ru":"Добавить источник","en":"Add source","he":"הוספת מקור"}'),
('fields.inheritSelectEntity', '{"ru":"Сущность","en":"Entity","he":"ישות"}'),
